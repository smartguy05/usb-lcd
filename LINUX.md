...
`usb-lcd-dashboard_0.12.2_all.deb` installs the dashboard on Ubuntu 24.04 LTS
(noble) and later.
...
```text
dist/usb-lcd-dashboard_0.12.2_all.deb
...
```bash
sudo apt install ./usb-lcd-dashboard_0.12.2_all.deb
```
