...
The web settings page has the same recovery action under **Settings → Display →
Reconnect LCD**. It reopens the device, reapplies screen, brightness and
orientation initialization, then repaints the full frame.
